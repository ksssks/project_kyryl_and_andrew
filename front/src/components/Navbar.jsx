        ...
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className='flex items-center gap-7'>
                ...
                <div className='group relative'>
                    <img onClick={() => token ? null : navigate('/login')} className='w-7 cursor-pointer dark:invert dark:bg-white' src={assets.profile} alt="Profile" />
                    {token &&
                        <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded  dark:bg-gray-700 dark:text-white'>
                                ...
                                <p onClick={() => navigate('/orders')} className='cursor-pointer hover:text-black dark:hover:text-gray-400'>Замовлення</p>
                                <p onClick={logout} className='cursor-pointer hover:text-black dark:hover:text-gray-400'>Вийти</p>
                            </div>
                        </div>
                    }
                </div>
