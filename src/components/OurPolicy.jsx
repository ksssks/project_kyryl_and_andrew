...
const OurPolicy = () => {
    return (
        <div
            ...
            <div>
                <img src={assets.coin} className='w-12 m-auto mb-5 dark:invert dark:bg-white' alt='Exchange'/>
            ...
            <div>
                <img src={assets.trophy} className='w-12 m-auto mb-5 dark:invert dark:bg-white' alt='Return'/>
            ...
            <div>
                <img src={assets.question} className='w-12 m-auto mb-5 dark:invert dark:bg-white' alt='Support'/>
                <p className='font-semibold dark:text-white'>Підтримка клієнтів</p>
                <p className='text-gray-400 dark:text-white'>24/7 відповідаємо на усі Ваші питання</p>
            </div>
        </div>
    );
};
