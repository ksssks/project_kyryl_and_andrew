            ...
            <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
                ...
                <div className='flex-gap-12 sm:gap-12 flex-col sm:flex-row'>
                    ...
                    <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
                        <div
                            className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[10%] w-full'>
                            {productData.image.map((item, index) => (
                                <img onClick={() => setImage(item)} src={item} key={index}
                                     className='w-[24%] sm:w-full sm:mb-3 flex-schrink-0 cursor-pointer' alt=''/>))}
                        </div>
                        ...
                        <div className='flex-1'>
                            ...
                            <button className='bg-black text-white px-10 py-3 text-sm active:bg-gray-700'>Додати у
                                корзину
                            </button>
